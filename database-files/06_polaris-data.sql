...
VALUES
    ...
    ('Amy Bear', 'bear.a@example.com', 'amy.jpg', 'Khoury College of Computer Science', 'Cybersecurity', NULL),
    ...
    ('Victoria Miko', 'miko.v@example.com', 'victoria.jpg', 'College of Science', 'Neuroscience', "Finance"),
    ('Raj Patel', 'patel.r@example.com', 'raj.jpg', 'College of Science', 'Neuroscience', "Finance"),
    ('Anya Kapoor', 'kapoor.a@example.com', 'anya.jpg', 'College of Social Sciences and Humanities', "Journalist", "Political Science"),
    ('Sana Khan', 'khan.s@example.com', 'sana.jpg', 'College of Social Sciences and Humanities', "Political Science", NULL),

    ('Nina Verma', 'verma.n@example.com', 'nina.jpg', 'Khoury College of Computer Science', 'Cybersecurity', NULL),
    ('Ishaan Malhotra', 'malhotra.i@example.com', 'ishaan.jpg', 'College of Science', 'Biology', NULL),
    ('Rohan Mehta', 'mehta.r@example.com', 'rohan.jpg', 'College of Arts, Media, and Design', "Graphic Design", NULL),
    ('Arjun Sen', 'sen.a@example.com', 'arjun.jpg', "College of Science", "Chemical Engineering", NULL),
...
VALUES
    ...
    (69, FALSE, TRUE, NULL, NULL, 4),
    (70, FALSE, TRUE, NULL, NULL, 4),
    (71, FALSE, TRUE, NULL, NULL, 14),
    (72, FALSE, TRUE, NULL, NULL, 14),
    (73, FALSE, TRUE, NULL, NULL, 1),
    (74, FALSE, TRUE, NULL, NULL, 4),
    (75, FALSE, TRUE, NULL, NULL, 7),
    (76, FALSE, TRUE, NULL, NULL, 4),
...
VALUES
    ...
    (2, 5, 5, FALSE, '2024-11-05 10:00:00'),
    (3, 5, 5, FALSE, '2024-11-04 10:30:00'),
    (3, 6, 6, FALSE, '2024-11-06 11:15:00'),
    (4, 6, 6, FALSE, '2024-11-05 11:45:00'),
    (4, 7, 7, FALSE, '2024-11-10 12:30:00'),
    (5, 8, 8, FALSE, '2024-11-03 13:45:00'),
    (5, 7, 7, FALSE, '2024-11-06 13:15:00'),
    (6, 9, 9, FALSE, '2024-11-07 14:00:00'),
    (6, 8, 8, FALSE, '2024-11-012 14:30:00'),
    (7, 9, 9, FALSE, '2024-11-01 15:00:00'),
    (7, 10, 10, FALSE, '2024-11-02 15:15:00'),
    (8, 11, 11, FALSE, '2024-11-02 16:30:00'),
    (8, 10, 10, FALSE, '2024-11-03 16:00:00'),
    (9, 11, 11, FALSE, '2024-11-03 17:00:00'),
    (9, 12, 12, FALSE, '2024-11-05 17:30:00'),
    (10, 13, 13, FALSE, '2024-11-04 18:45:00'),
    (10, 12, 12, FALSE, '2024-11-09 18:00:00'),
    (11, 13, 13, FALSE, '2024-11-05 19:00:00'),
    (11, 14, 14, FALSE, '2024-11-06 19:15:00'),
    (12, 1, 1, FALSE, '2024-11-06 20:30:00'),
    (12, 14, 14, FALSE, '2024-11-08 20:00:00'),
    (13, 1, 1, FALSE, '2024-11-07 09:30:00'),
    (13, 2, 2, FALSE, '2024-11-09 21:00:00'),
    (14, 3, 3, FALSE, '2024-11-01 08:00:00'),
    (14, 2, 2, FALSE, '2024-11-04 07:00:00'),
    (15, 10, 10, FALSE, '2024-11-02 15:15:00'),
    (15, 11, 11, FALSE, '2024-11-05 16:30:00'),
    (16, 10, 10, FALSE, '2024-11-03 16:00:00'),
    (16, 11, 11, FALSE, '2024-11-06 17:00:00'),
    (17, 12, 12, FALSE, '2024-11-05 17:30:00'),
    (17, 13, 13, FALSE, '2024-11-07 18:45:00'),
    (18, 12, 12, FALSE, '2024-11-09 18:00:00'),
    (18, 13, 13, FALSE, '2024-11-13 19:00:00'),
    (19, 14, 14, FALSE, '2024-11-06 19:15:00'),
    (19, 1, 1, FALSE, '2024-11-07 20:30:00'),
    (20, 14, 14, FALSE, '2024-11-08 20:00:00'),
    (20, 1, 1, FALSE, '2024-11-08 09:30:00'),
    (21, 2, 2, FALSE, '2024-11-09 21:00:00'),
    (21, 3, 3, FALSE, '2024-11-11 08:00:00'),
    (22, 7, 7, FALSE, '2024-11-08 09:00:00'),
    (22, 8, 8, FALSE, '2024-11-09 09:00:00'),
    (22, 9, 9, FALSE, '2024-11-12 09:00:00'),
    (23, 6, 6, FALSE, '2024-11-06 11:15:00'),
    (23, 6, 6, FALSE, '2024-11-10 11:45:00'),
    (24, 7, 7, FALSE, '2024-11-01 12:30:00'),
    (24, 8, 8, FALSE, '2024-11-03 13:45:00'),
    (25, 7, 7, FALSE, '2024-11-06 13:15:00'),
    (25, 9, 9, FALSE, '2024-11-07 14:00:00'),
    (26, 8, 8, FALSE, '2024-11-012 14:30:00'),
    (26, 9, 9, FALSE, '2024-11-013 15:00:00'),
    (15, 15, 11, FALSE, '2024-12-05 16:30:00'),
    (16, 16, 10, FALSE, '2024-12-03 16:00:00'),
    (16, 17, 11, FALSE, '2024-12-06 17:00:00'),
    (17, 18, 12, FALSE, '2024-12-05 17:30:00'),
    (17, 19, 13, FALSE, '2024-12-07 18:45:00'),
    (18, 20, 12, FALSE, '2024-12-09 18:00:00'),
    (18, 21, 13, FALSE, '2024-12-13 19:00:00'),
    (19, 22, 14, FALSE, '2024-12-06 19:15:00'),
    (19, 23, 1, FALSE, '2024-12-07 20:30:00'),
    (20, 24, 14, FALSE, '2024-12-08 20:00:00'),
    (20, 15, 1, FALSE, '2024-12-08 09:30:00'),
    (21, 16, 2, FALSE, '2024-12-09 21:00:00'),
    (21, 17, 3, FALSE, '2024-12-11 08:00:00'),
    (22, 18, 7, FALSE, '2024-12-08 09:00:00'),
    (22, 19, 8, FALSE, '2024-12-09 09:00:00'),
    (22, 20, 9, FALSE, '2024-12-12 09:00:00'),
    (23, 21, 6, FALSE, '2024-12-06 11:15:00'),
    (23, 22, 6, FALSE, '2024-12-10 11:45:00'),
    (24, 22, 7, FALSE, '2024-12-01 12:30:00'),
    (24, 23, 8, FALSE, '2024-12-03 13:45:00'),
    (25, 24, 7, FALSE, '2024-12-06 13:15:00'),
    (25, 15, 9, FALSE, '2024-12-07 14:00:00'),
    (26, 16, 8, FALSE, '2024-12-012 14:30:00'),
    (26, 18, 9, FALSE, '2024-12-013 15:00:00');
    
    

INSERT INTO Chats (senderId, recipientId, text)
VALUES
    (1, 1, 'Hi Andy, can you help me with my application?'),
    (1, 1, 'Sure, Isla! Let me know the details.'),
    (6, 5, 'Here is a role that I thought would be a good fit!'),
    (5, 6, 'Thanks! I will take a look!'),
    (1, 2, 'Hey Sandra, are you free for a quick chat?'),
    (2, 1, 'Of course, let me finish this task first.'),
    (6, 5, 'Do you have any updates?'),
    (5, 6, 'Yes, I''ll send them over now.'),
    (1, 3, 'Can you review this job posting this week?'),
    (3, 1, 'Sure, I''ll get on it later today.'),
    (1, 3, 'What time is the networking tomorrow?'),
    (3, 1, 'It''s scheduled for 10 AM.'),
    (2, 4, 'Any plans for the weekend?'),
    (4, 2, 'Not yet, do you have any suggestions?'),
    (12, 15, 'Don''t forget to submit that application today!'),
    (15, 12, 'Thanks for the reminder! I''ll do it now.'),
    (3, 7, 'Can you share the document link?'),
    (7, 3, 'I just sent it to your email.'),
    (3, 7, 'Are you joining the employee panel later?'),
    (7, 3, 'Yes, I''ll be there at 3 PM.'),
    (13, 8, 'Can we push the deadline to next week?'),
    (8, 13, 'I''ll check with the manager and let you know.'),
    (1, 2, 'How''s your progress on the assignment?'),
    (2, 1, 'I''m almost done, just finalizing a few details.'),
    (1, 3, 'Let''s catch up after class today.'),
    (3, 1, 'Sound''s great.'),
    (2, 4, 'Sounds good, see you then.'),
    (12, 5, 'Do you need help with the client presentation?'),
    (2, 6, 'Yes, that would be great!'),
    (3, 7, 'Can you resend the project brief?'),
    (13, 8, 'Sure, give me a moment.'),
    (3, 9, 'I need your feedback on this design.'),
    (14, 10, 'I''ll review it right away.'),
    (4, 11, 'Are you available for a quick call?'),
    (4, 12, 'Yes, I''ll call you in 10 minutes.'),
    (15, 13, 'The client loved your proposal!'),
    (5, 14, 'That''s great to hear, thank you!'),
    (5, 15, 'Can you approve the budget request?'),
    (16, 16, 'I''ll discuss it with the team first.'),
    (6, 17, 'Let''s finalize the slides by noon.'),
    (6, 18, 'Alright, I''m on it.'),
    (17, 19, 'Do we have an agenda for the meeting?'),
    (7, 20, 'Yes, I''ll share it shortly.'),
    (18, 21, 'When''s the project review?'),
    (8, 22, 'It''s scheduled for Friday.'),
    (9, 23, 'Can you join the training session tomorrow?'),
    (23, 9, 'Of course!'),
    (24, 19, 'Can we schedule a coffee chat soon?'),
    (19, 24, 'I''ll check my schedule and confirm.'),
    (10, 25, 'The code review is scheduled for 2 PM.'),
    (11, 26, 'Thanks for letting me know.');
...
VALUES
    ...
    (2, 2, 'Priya Singh', 'Innovative Leadership Strategies Day 2', '2024-12-05 14:00:00', TRUE),
    (2, 2, 'Priya Singh', 'Innovative Leadership Strategies Day 3', '2024-12-06 14:00:00', TRUE),
    (2, 2, 'Priya Singh', 'Innovative Leadership Strategies Day 4', '2024-12-07 14:00:00', TRUE),
    (3, 3, 'Liam West', 'The Future of AI in Everyday Life', '2024-12-06 11:00:00', TRUE),
    (3, 3, 'Liam West', 'The Future of AI in Everyday Life Day 2', '2024-12-07 11:00:00', TRUE),
    (3, 3, 'Liam West', 'The Future of AI in Everyday Life Day 3', '2024-12-08 11:00:00', TRUE),
    (4, 4, 'Noah Green', 'Advances in Healthcare Consulting', '2024-12-07 09:30:00', TRUE),
    (4, 2, 'Noah Green', 'Advances in Healthcare Consulting Day 2', '2024-12-10 09:30:00', TRUE),
...
VALUES
    (1, 1, 'Reviewed the initial assignment; good progress overall.', 'Focus on improving time management.'),
    (1, 2, 'Completed training on communication skills.', 'Consider additional practice sessions.'),
    (1, 3, 'Started work on the project proposal; needs refinement.', 'Set clearer goals for the next steps.'),
    (2, 4, 'Improved performance in coding exercises.', 'Encourage participation in coding challenges.'),
    (12, 5, 'Presented final report; excellent quality.', 'Explore opportunities for leadership roles.'),
    (2, 6, 'Successfully completed the first module of the course.', 'Plan for deeper engagement in the next module.'),
    (3, 7, 'Completed all deliverables on time.', 'Work on expanding technical skill set.'),
    (13, 8, 'Active participation in group discussions.', 'Encourage mentorship opportunities for peers.'),
    (3, 9, 'Delivered the presentation; good feedback received.', 'Refine presentation delivery for greater impact.'),
    (14, 10, 'Improved consistency in project submissions.', 'Develop strategies to maintain motivation.'),
    (4, 11, 'Good understanding of key concepts demonstrated.', 'Encourage applying knowledge to real-world projects.'),
    (4, 12, 'Made significant progress on case study.', 'Seek opportunities for cross-functional collaboration.'),
    (5, 14, 'Significant improvement in problem-solving skills.', 'Focus on building confidence in solutions.'),
    (5, 15, 'Teamwork skills have improved greatly.', 'Encourage taking initiative in group settings.'),
    (16, 16, 'Exceptional grasp of complex algorithms.', 'Challenge with higher-level problems.'),
    (6, 17, 'Regularly contributes insightful ideas during meetings.', 'Focus on public speaking to articulate ideas clearly.'),
    (6, 18, 'Met all quarterly goals with excellent outcomes.', 'Plan for stretch goals next quarter.'),
    (17, 19, 'Built strong relationships with team members.', 'Encourage collaboration in leadership roles.'),
    (7, 20, 'Creative problem-solving skills are evident.', 'Push for more innovative solutions.'),
    (18, 21, 'Successfully launched the project on schedule.', 'Work on identifying and mitigating risks early.'),
    (8, 22, 'Excels in delivering well-researched reports.', 'Challenge with presenting concise summaries.'),
    (9, 23, 'Adaptability to new challenges has been impressive.', 'Encourage leading initiatives.'),
    (19, 24, 'Organized a successful workshop for peers.', 'Build on facilitation skills for greater impact.'),
    (10, 25, 'Received positive feedback from stakeholders.', 'Focus on building strategic thinking skills.'),
    (11, 26, 'Consistently meets all deadlines.', 'Encourage mentoring junior team members.');
