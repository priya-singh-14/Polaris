...
VALUES
    ...
    (1, 2, 2, FALSE, '2024-11-02 09:00:00'),
    (1, 3, 3, FALSE, '2024-11-03 08:30:00'),
    (1, 6, 6, FALSE, '2024-11-06 09:00:00'),
    (1, 7, 7, FALSE, '2024-11-08 09:00:00'),
    (1, 8, 8, FALSE, '2024-11-10 09:00:00'),
    (1, 9, 9, FALSE, '2024-11-12 09:00:00'),
    ...
    (1, 4, 4, FALSE, '2024-11-015 09:15:00'),
...
VALUES
    (1, 1, 'John Aquarius', 'Finance and Community Relations', '2024-12-01 10:00:00', TRUE),
    (1, 1, 'John Aquarius', 'Finance and Community Relations', '2024-12-02 10:00:00', TRUE),
    (1, 1, 'John Aquarius', 'Finance and Community Relations Day 3', '2024-12-03 11:00:00', FALSE),
    (2, 2, 'Priya Singh', 'Innovative Leadership Strategies', '2024-12-05 14:00:00', TRUE),
    (3, 3, 'Liam West', 'The Future of AI in Everyday Life', '2024-12-06 11:00:00', TRUE),
    (4, 4, 'Noah Green', 'Advances in Healthcare Consulting', '2024-12-07 09:30:00', TRUE),
    (2, 3, 'Priya Singh', 'Day 2: Finance Leadership Summit', '2024-12-19 11:00:00', TRUE),
    (3, 4, 'Liam West', 'The AI Revolution', '2024-12-20 14:00:00', TRUE),
    (4, 5, 'Noah Green', 'Healthcare Innovations 2024', '2024-12-21 12:00:00', TRUE),
    (5, 5, 'Ryan Davis', 'Modern Marketing Tactics', '2024-12-08 13:00:00', TRUE),
    (6, 6, 'Aiden White', 'Designing for Creativity', '2024-12-09 15:00:00', TRUE),
    (7, 7, 'Benjamin Walker', 'Breakthroughs in Clinical Research', '2024-12-10 10:30:00', TRUE),
    (5, 6, 'Ryan Davis','Creative Strategies for Marketers', '2024-12-22 13:00:00', TRUE),
    (6, 7, 'Aiden White','Design Thinking in Practice', '2024-12-23 15:00:00', TRUE),
    (7, 8, 'Benjamin Walker','Clinical Research Breakthroughs', '2024-12-24 10:30:00', TRUE),
    (8, 8, 'Jack Hernandez','Artificial Intelligence and Ethics', '2024-12-11 16:00:00', TRUE),
    (9, 9, 'Marcus Green','Product Management in the Digital Era', '2024-12-12 14:30:00', TRUE),
    (10, 10, 'Aria Mitchell', 'Effective Sales Techniques in 2024', '2024-12-13 12:00:00', TRUE),
    (8, 9, 'Jack Hernandez','Ethical AI: Challenges Ahead', '2024-12-25 16:00:00', TRUE),
    (9, 10, 'Marcus Green', 'Agile Product Management', '2024-12-26 14:30:00', TRUE),
    (10, 11, 'Aria Mitchell', 'Sales Strategies for 2025', '2024-12-27 12:00:00', TRUE),
    (11, 11, 'Cain Greek', 'Data Science for Decision Making', '2024-12-14 11:00:00', TRUE),
    (12, 12, 'Lou Edwards', 'Building University-Industry Partnerships', '2024-12-15 09:00:00', TRUE),
    (11, 12, 'Cain Greek', 'Data Science Impact on Business', '2024-12-28 11:00:00', TRUE),
    (12, 13, 'Lou Edwards', 'University-Industry Collaborations', '2024-12-29 09:00:00', TRUE),
    (13, 13, 'Mike Young', 'Renewable Energy Engineering', '2024-12-16 15:00:00', TRUE),
    (14, 14, 'Eve Brooks', 'Streamlining Logistics Operations', '2024-12-17 13:30:00', TRUE),
    (13, 14, 'Eve Brooks', 'Engineering Sustainability', '2024-12-30 15:00:00', TRUE);